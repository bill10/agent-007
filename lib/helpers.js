...
export const MESSAGE_PATTERNS = [
  ...
  // Codex's own trust dialog ("› 1. Trust and continue  2. Quit"). Unmatched,
  // it read as WAITING, and an agent message typed into it answered it: the
  // Enter picked option 1 and saved the folder as trusted.
