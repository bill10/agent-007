...
export const MESSAGE_PATTERNS = [
  ...
  // "select" as well as "confirm": the multiple-choice prompt (AskUserQuestion)
  // footers with "Enter to select ... Esc to cancel", and without this it reads
  // as plain WAITING -- an agent blocking on a question looks exactly like one
  // resting at the prompt.
  /Enter\s*to\s*(confirm|select)\s*.?\s*Esc\s*to\s*cancel/i,
];
