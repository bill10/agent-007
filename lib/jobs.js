...
export function buildJobPrompt(job) {
  ...
  parts.push(
    ...
    '',
    'When the work is finished: run /review, fix what it raises, run /review again,',
    'then /ship. The board watches for the pull request /ship opens and moves this',
    'job to Review when it appears.',
  );
  return parts.join('\n');
}
