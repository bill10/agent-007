...
//   server/http.js   HTTP routes (/api/browse, /api/jobs, origin + auth checks)
...
// argument: http.js must not import ws.js, and POST /api/jobs has to repaint
// every open board the moment an agent posts a card.
